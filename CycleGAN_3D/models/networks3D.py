...
class ConditionGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=16, img_size=(1, 64, 64, 64), norm_layer=nn.BatchNorm3d, use_dropout=False, n_blocks=9, padding_type='reflect'):
        assert(n_blocks >= 0)
