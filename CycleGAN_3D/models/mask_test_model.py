...
class MaskTestModel(BaseModel):
    def name(self):
        return 'MaskTestModel'
    ...
    def set_input(self, input, mask, condition):
    ...
    def forward(self):
        self.fake_B = self.netG(self.real_A, self.condition, fwd=True, mask=self.mask)
