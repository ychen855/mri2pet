    ...
    for i in range(n_fold):
        ...
        with open(job_file, 'w') as f:
            ...
            if training:
                ...
                lines.append('PYTHON_PATH=/scratch/ychen855/mri2pet/CycleGAN_3D/train_condition.py')
                ...
                lines.append('PYTHON_DIR=/scratch/ychen855/mri2pet/CycleGAN_3D/test_condition.py')
