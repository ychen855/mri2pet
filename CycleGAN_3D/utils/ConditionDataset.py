...
class ConditionDataSet(torch.utils.data.Dataset):
    ...
    def __init__(self, data_path, cross_validation=True, data_split='data_split.csv', nth_fold=0,
        ...
        # self.cond_list = self.cond_list / np.max(self.cond_list) * 2.0
        # self.cond_list -= 1.0
    ...
    def __getitem__(self, index):
        ...
        return torch.from_numpy(image_np), torch.from_numpy(label_np), condition  # this is the final output to feed the network
