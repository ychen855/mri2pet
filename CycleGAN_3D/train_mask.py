...
import utils.MaskDataset as MaskDataset
...
if __name__ == '__main__':
    ...
    trainTransforms = [
                MaskDataset.Resample(opt.new_resolution, opt.resample),
                MaskDataset.Augmentation(),
                MaskDataset.Padding((opt.patch_size[0], opt.patch_size[1], opt.patch_size[2])),
                MaskDataset.RandomCrop((opt.patch_size[0], opt.patch_size[1], opt.patch_size[2]), opt.drop_ratio, min_pixel),
                ]
