...
if __name__ == '__main__':
    ...
    if opt.cross_validation:
        train_set = ConditionDataSet(opt.data_path, True, opt.data_split, opt.fold, col=col_map[opt.feature], which_direction='AtoB', transforms=trainTransforms, shuffle_labels=True, train=True)
    else:
        train_set = ConditionDataSet(opt.data_path, col=col_map[opt.feature], which_direction='AtoB', transforms=trainTransforms, shuffle_labels=True, train=True)
